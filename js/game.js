document.addEventListener('DOMContentLoaded', () => {
    ...
    backgroundImage.src = 'game_background_tiled.png'; 
    ...
    backgroundImage.onload = () => {
        ...
        playerImage.src = 'player_bird.png'; // You'll need to create this image
        let player = {
        ...
        bulletImage.src = 'bullet_fireball.png'; // You'll need to create this image
        ...
        enemyImage.src = 'enemy_aswang.png'; // You'll need to create this image
